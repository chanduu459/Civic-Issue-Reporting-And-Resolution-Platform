...
export default function OfficerListEdit() {
  ...
  const handleEditClick = (officer) => {
    navigate("/super-admin/welcome/officers/editform", { state: { officer } });
  };

  if (loading) return <p className="loading-text">Loading officers...</p>;
  if (error) return <p className="error-text">{error}</p>;
  if (officers.length === 0) return <p className="no-data">No officers found.</p>;
    ...
    <>
      ...
      <div className="page-wrapper">
        <div className="header-row">
          <h2 className="page-title">Edit Officers</h2>
