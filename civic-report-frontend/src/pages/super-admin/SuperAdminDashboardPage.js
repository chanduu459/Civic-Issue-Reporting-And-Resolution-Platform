...
function WelcomePage() {
  ...
  const isDashboard = location.pathname === "/super-admin/welcome";
  ...
  const menuItems = [
    { to: "/super-admin/welcome", label: "Home", icon: "🏠" },
    { to: "/super-admin/welcome/admins", label: "Admins", icon: "🧑‍💼" },
    { to: "/super-admin/welcome/officers", label: "Officers", icon: "👮" },
    { to: "/super-admin/welcome/users", label: "Users", icon: "👥" },
    { to: "/super-admin/welcome/issues", label: "Issues", icon: "📋" },
    { to: "/super-admin/welcome/reports", label: "Reports", icon: "📈" },
    { to: "/super-admin/welcome/settings", label: "Settings", icon: "⚙️" },
  ];
